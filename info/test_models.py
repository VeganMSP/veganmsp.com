...
class RestaurantLocationModelTestCase(TestCase):
	...
	def test_address_label(self):
		...
		field_label = restaurant_location._meta.get_field('address').verbose_name
...
class LinkCategoryModelTestCase(TestCase):
	...
	def test_object_name_is_link_category_path_level_4(self):
		...
		expected_object_name = 'Link Category 0 -> Link Category 1 -> Link Category 2 -> Link Category 3'
		self.assertEqual(str(link_category), expected_object_name)
